        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeveloperProfileId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PublicSlug = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BlogPosts_DeveloperProfiles_DeveloperProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Certificates_DeveloperProfiles_DeveloperProfileId",
                        column: x => x.DeveloperProfileId,
                        principalTable: "DeveloperProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GithubAccounts_DeveloperProfiles_DeveloperProfileId",
                        column: x => x.DeveloperProfileId,
                        principalTable: "DeveloperProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProblemStatement = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
                    ApproachesTried = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    FinalSolution = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RepoUpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Repositories_GithubAccounts_GithubAccountId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BlogPosts_DeveloperProfileId",
                table: "BlogPosts",
                column: "DeveloperProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_Certificates_DeveloperProfileId",
                table: "Certificates",
                column: "DeveloperProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_DeveloperProfiles_PublicSlug",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GithubAccounts_DeveloperProfileId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Repositories_GithubAccountId",
                table: "Repositories",
